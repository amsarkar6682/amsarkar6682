...
**Founder @ APPGENZ** · FlutterFlow Expert · App Builder · West Bengal, India 🇮🇳

I build Flutter & FlutterFlow apps, sell UI templates on the marketplace, and share tutorials on YouTube. Currently shipping **Intake** — an AI-powered nutrition & fitness tracker live on iOS & Android.
...
- 📱 **[Intake App](https://appgenz.com)** — AI nutrition & fitness tracker · Gemini AI + Firebase · Live on App Store & Play Store
- 🛍 **APPGENZ Templates** — FlutterFlow UI templates on the marketplace (Flingr, NeoMart, Bookify, Expense Tracker)
- 📺 **YouTube** — FlutterFlow tutorials, UI builds, app development content
...
![FlutterFlow](https://img.shields.io/badge/FlutterFlow-4285F4?style=flat-square&logo=flutter&logoColor=white)
...
![RevenueCat](https://img.shields.io/badge/RevenueCat-F25A18?style=flat-square&logo=revenuecat&logoColor=white)
